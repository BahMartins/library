...
public class PopularBank {
	...
	public static void main(String[] args) {
		...
		Book capitaes = createBook("978-8-50-831169-1", "Capitaes da Areia",
	...
	private static Book createBook(String isbn, String title, String date,
		...
		book.setIsbn(isbn);
		book.setTitle(title);
		book.setReleaseDate(parseData(date));
		book.setPrice(price);
